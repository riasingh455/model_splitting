...
middling_devs=(3 4 5 6 7 12 17 18 19 20 21 22 24 25 26 27 28 30 31 42)

log_path="/home/animesh/model_splitting/logs/sweep/b-2-5/"
mkdir -p ${log_path}
...
#for run in 1;
#do
world_sizes=(4 3 2) #resnet-18 max splits is 6 -> empirically found, but only 4 can run reliably
# batches=(4)
# num_batches=(10)
for run in {1..10};
do 
