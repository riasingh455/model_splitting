...
#14, 31, 32, 36, 41
middling_devs=(3 4 5 7 10 11 12 15 16 17 19 21 23 27 28 29 30 33 35 37 38 39 40 42)
fragile_devs=(2 6 8 9 13 18 20 24 25 26)
#log_path="/home/animesh/full_sweep_logs/fragile_rank/b-${1}-${2}/"
log_path="/home/animesh/full_sweep_logs/full_rank/redo/b-${1}-${2}/"
...
#clock_devs ${good_ones[@]}
            #(3  4 5   7 10 11  12  15 16 17 19 21 23 27 28 29 30 33 35 37 38 39 40 42)
range_start=(4 22 22 24 24 4 24 14 22 24 4 14 14 4 24 4 4 14 0 4 14 14 14 14)
range_end=(13 28 28 28 28 13 28 23 28 28 13 23 23 13 28 13 13 23 5 13 23 23 23 23)
