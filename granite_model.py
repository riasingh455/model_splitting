...
# pip install granite-tsfm --no-deps

# commands i used to run:
# python granite_model.py --model-type ts_transformer --model-split-type modules --world 3 --batch-size 4
# cat ts_transformer_modules_3_4/flop.dict
# cat ts_transformer_modules_3_4/stages.dict
...
if __name__ == "__main__":
    ...
    # elif args.model_type == "ttm_r2":
    #     pretrained_model = TTMWrapper(
