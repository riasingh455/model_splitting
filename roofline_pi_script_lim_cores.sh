...
log_path="/home/animesh//model_splitting/logs/1_roofline/"
...
log_path="/home/animesh//model_splitting/logs/1_roofline/${model_type}_${model_split}/"
...
do
        ...
        do
                ...
                # val=${good_ones[$i]}
                python3 ${script_path}/main_infer_exec.py --cores 1 --rank $rank --world $world --ip $master --port 8123 --warmup 1 --images /home/animesh//model_splitting/bear.jpeg /home/animesh//model_splitting/penguin.jpeg --batch-size $batch_size --batch-num $batch_num --iters $iters --model-type $model_type --model-split-type $model_split >> ${log_path}/${world}_size/${batch_size}_${batch_num}/speed_chronos${t}.log &
                pids+=($!)
