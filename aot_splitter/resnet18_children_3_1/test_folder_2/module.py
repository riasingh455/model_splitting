...
class test_2(torch.nn.Module):
    def __init__(self):
        super().__init__()
        setattr(self, 'layer4', torch.load(r'resnet18_children_3_1/test_folder_2/layer4.pt', weights_only=False)) # Module(   (0): Module(     (conv1): Module()     (bn1): Module()     (conv2): Module()     (bn2): Module()     (downsample): Module(       (0): Module()       (1): Module()     )   )   (1): Module(     (conv1): Module()     (bn1): Module()     (conv2): Module()     (bn2): Module()   ) )
        setattr(self, 'fc', torch.load(r'resnet18_children_3_1/test_folder_2/fc.pt', weights_only=False)) # Module()
        self.load_state_dict(torch.load(r'resnet18_children_3_1/test_folder_2/state_dict.pt'))
    ...
    def forward(self, relu__12):
        ...
        adaptive_avg_pool2d = torch.ops.aten.adaptive_avg_pool2d.default(relu__3, [1, 1]);  relu__3 = None
