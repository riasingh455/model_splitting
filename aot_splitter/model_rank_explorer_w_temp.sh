...
do
    ...
    do
        ...
        do
                ...
                path_dst="${path_prefix}/logs/single_group_heat_con/${node_prefix}/${model_type}_${model_split}_onnx/all_dev/${repeat}/"
                mkdir -p ${path_dst}
		...
		do
			...
			then
				...
				path_dst="${path_prefix}/logs/single_group_heat_con/${node_prefix}/${model_type}_${model_split}_onnx/per_dev/${repeat}/"
				mkdir -p ${path_dst}
