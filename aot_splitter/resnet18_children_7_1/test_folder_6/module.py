...
class test_6(torch.nn.Module):
    def __init__(self):
        super().__init__()
        setattr(self, 'fc', torch.load(r'resnet18_children_7_1/test_folder_6/fc.pt', weights_only=False)) # Module()
        self.load_state_dict(torch.load(r'resnet18_children_7_1/test_folder_6/state_dict.pt'))
