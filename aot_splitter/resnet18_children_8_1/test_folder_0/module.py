...
class test_0(torch.nn.Module):
    def __init__(self):
        super().__init__()
        setattr(self, 'conv1', torch.load(r'resnet18_children_8_1/test_folder_0/conv1.pt', weights_only=False)) # Module()
        setattr(self, 'bn1', torch.load(r'resnet18_children_8_1/test_folder_0/bn1.pt', weights_only=False)) # Module()
        self.load_state_dict(torch.load(r'resnet18_children_8_1/test_folder_0/state_dict.pt'))
