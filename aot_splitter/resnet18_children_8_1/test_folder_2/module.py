...
class test_2(torch.nn.Module):
    def __init__(self):
        super().__init__()
        setattr(self, 'layer1', torch.load(r'resnet18_children_8_1/test_folder_2/layer1.pt', weights_only=False)) # Module(   (0): Module(     (conv1): Module()     (bn1): Module()     (conv2): Module()     (bn2): Module()   )   (1): Module(     (conv1): Module()     (bn1): Module()     (conv2): Module()     (bn2): Module()   ) )
        self.load_state_dict(torch.load(r'resnet18_children_8_1/test_folder_2/state_dict.pt'))
