...
f_10 () {
    ...
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 0 4 1 ${dt}"
    ...
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 0 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[14]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[14]}_5_0_2.log &" &
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 1 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[11]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[11]}_5_1_2.log &" &
    wait
    dt=$(date -d '+60 seconds' +%s)
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 0 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[14]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[14]}_5_0_2.log &" &
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 1 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[11]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[11]}_5_1_2.log &" &
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 2 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[12]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[12]}_5_2_2.log &" &
    wait
    dt=$(date -d '+60 seconds' +%s)
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 0 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[14]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[14]}_5_0_2.log &" &
    ...
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 2 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[12]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[12]}_5_2_2.log &" &
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 3 4 1 ${dt}"
    ...
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 3 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[13]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[13]}_5_3_2.log &" &
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 4 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[10]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[10]}_5_4_2.log &" &
    wait
    dt=$(date -d '+60 seconds' +%s)
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 0 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[14]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[14]}_5_0_2.log &" &
...
f_9 () {
    ...
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[4]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[4]}_5_0_2.log &" &
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 1 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[1]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[1]}_5_1_2.log &" &
    wait
    dt=$(date -d '+60 seconds' +%s)
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 0 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[4]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[4]}_5_0_2.log &" &
    ...
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[1]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[1]}_5_1_2.log &" &
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 2 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[2]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[2]}_5_2_2.log &" &
    wait
    dt=$(date -d '+60 seconds' +%s)
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 0 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[4]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[4]}_5_0_2.log &" &
    ...
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[3]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[3]}_5_3_2.log &" &
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 4 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[0]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[0]}_5_4_2.log &" &
    wait
    dt=$(date -d '+60 seconds' +%s)
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 0 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[4]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[4]}_5_0_2.log &" &
...
f_8 () {
    ...
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[9]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[9]}_5_0_2.log &" &
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 1 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[6]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[6]}_5_1_2.log &" &
    wait
    dt=$(date -d '+60 seconds' +%s)
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 0 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[9]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[9]}_5_0_2.log &" &
    ...
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[6]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[6]}_5_1_2.log &" &
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 2 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[7]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[7]}_5_2_2.log &" &
    wait
    dt=$(date -d '+60 seconds' +%s)
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 0 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[9]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[9]}_5_0_2.log &" &
    ...
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[8]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[8]}_5_3_2.log &" &
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 4 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[5]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[5]}_5_4_2.log &" &
    wait
    dt=$(date -d '+60 seconds' +%s)
    command="[[ $(ps -aex | grep 'onnxtest' | wc -l) -gt 1 ]] && wait $(ps -aex | grep 'onnxtest' | awk '{print $1}');python3 onnxtest_w_json_bs.py 1 ./vit_splits_5_2 0 4 1 ${dt}"
    timeout 10m ssh -o ConnectTimeout=10 -o BatchMode=yes -o StrictHostKeyChecking=no animesh@${nodes[9]} "pushd $path_prefix/aot_splitter; source /home/animesh/model_splitting/pi-torch/bin/activate; ${command} > ${path_dst}/${repeat}/speed_chronos${nodes[9]}_5_0_2.log &" &
